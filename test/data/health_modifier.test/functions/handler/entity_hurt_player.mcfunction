...
data modify storage : _ append value {}
  ...
  tellraw @a [{"text": "Debug» ", "color": "green"}, "health_modifier.test:handler/entity_hurt_player» ", {"storage": ":", "nbt": "_[-1]"}, ", hurt_time = ", {"score": {"name": "@s", "objective": "health_modifier.hurt_time"}}]
